...
module.exports =
  new Package('cli-docs', [basePackage, contentPackage])
    ...
    .config(function (renderDocsProcessor) {
      try {
        // console.log('路径', CLI_SOURCE_PATH)
        ...
        console.log('本地模式,这个没有用')
        renderDocsProcessor.extraData.cliVersionInfo = { gitRepoInfo: { owner: 'chen', repo: 'unuse' }, currentVersion: { raw: '999999' } }
      }
    })
